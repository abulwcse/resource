...
type GetCustomerProjectReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetCustomerProjectReply) Reset() {
	*x = GetCustomerProjectReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCustomerProjectReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCustomerProjectReply) ProtoMessage() {}

func (x *GetCustomerProjectReply) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCustomerProjectReply.ProtoReflect.Descriptor instead.
func (*GetCustomerProjectReply) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{1}
}

func (x *GetCustomerProjectReply) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
var file_resource_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x3b, 0x0a, 0x19, 0x47, 0x65,
	...
	0x74, 0x6f, 0x6d, 0x65, 0x72, 0x49, 0x64, 0x22, 0x35, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x43, 0x75,
	0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x66,
	0x0a, 0x04, 0x43, 0x6f, 0x72, 0x65, 0x12, 0x5e, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x43, 0x75, 0x73,
	0x74, 0x6f, 0x6d, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x23, 0x2e, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x75, 0x73, 0x74, 0x6f,
	...
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x1e, 0x5a, 0x1c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x62, 0x75, 0x6c, 0x77, 0x63, 0x73, 0x65, 0x2f, 0x72, 0x65,
...
var file_resource_proto_goTypes = []interface{}{
	(*GetCustomerProjectRequest)(nil), // 0: resource.GetCustomerProjectRequest
	(*GetCustomerProjectReply)(nil),   // 1: resource.GetCustomerProjectReply
}
var file_resource_proto_depIdxs = []int32{
	0, // 0: resource.Core.GetCustomerProject:input_type -> resource.GetCustomerProjectRequest
	1, // 1: resource.Core.GetCustomerProject:output_type -> resource.GetCustomerProjectReply
...
func file_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_resource_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCustomerProjectReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
